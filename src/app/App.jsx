...
function MainApp(){
 ...
 if(!data)return <div className="splash"><img src="/branding/splash.png" alt="GENIUS ADMIN PREMIUM"/><b>GENIUS ADMIN PREMIUM</b><small>Offline First • جاري تجهيز النظام...</small></div>;
